                ...
                <g:if test="${paymentList}">
                    <g:each in="${paymentList}" var="payment">
                        <tr class="pagination-table-data-row ${payment.deleted ? 'deleted' : payment.status.toLowerCase()}">
                            <td class="pagination-table-column-data pagination-data-value"><g:formatDate format="dd/MM/yyyy"
                            ...
                            <td class="pagination-table-column-data pagination-data-value"><g:formatMonetaryValue value='${payment.value}'/></td>
                            <td class="pagination-table-column-data"><g:message code="ENUM.BillingType.${payment.billingType}"/></td>
                            <td class="pagination-table-column-data pagination-data-value"><g:formatDate format="dd/MM/yyyy"
                                                                                                         date="${payment.dueDate}"/></td>
                            <td class="pagination-table-column-data"><g:message code="ENUM.PaymentStatus.${payment.status}"/></td>
